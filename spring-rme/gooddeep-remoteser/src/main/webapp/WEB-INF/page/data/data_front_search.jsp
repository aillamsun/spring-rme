  ...
  <div class="col-md-12 column">
    ...
    <!-- ###########################左-->
      ...
      <div class="col-md-8 column right-border left-border">
       ...
       <div class="input-group">
        <input type="text" class="form-control"  placeholder="关键内容" style="height:30px" >
        <span class="input-group-btn">
        <button class="btn btn-default" type="button" style="height:30px"> 搜索 </button>
        </span> </div>
        </div>
        </div>
        <div class="row clearfix ">
          <div class="col-md-12 column text-left">
            <ul class="breadcrumb">
				<li>
					 <a href="http://www.runoob.com/try/bootstrap/layoutit/#">首页</a>
				</li>
				<li>
					 <a href="http://www.runoob.com/try/bootstrap/layoutit/#">数码产品</a>
				</li>
				<li class="active">
					手机
				</li>
