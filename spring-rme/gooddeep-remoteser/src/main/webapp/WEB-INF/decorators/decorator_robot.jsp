				...
				<div class="row clearfix">
					<div class="col-md-2 column">
						<ul class="nav nav-tabs nav-stacked">
							<li><a href="p_robot/robot/robot_index.shtml">首页</a></li>
							<li class="active"><a href="p_robot/robot/robot_replys_page.shtml">词条</a></li>
							<!-- <li ><a href="http://www.runoob.com/try/bootstrap/layoutit/#">词条</a></li> -->
							<li><a href="p_robot/robot/setting_index.shtml">设置</a></li>
							<li ><a href="p_robot/robot/report_index.shtml">上报</a></li>
